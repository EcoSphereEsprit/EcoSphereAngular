...
@NgModule({
    imports: [RouterModule.forChild([
        ...
        { path: 'details/:id', component: BlogDetailComponent, canActivate: [authGuard] },
        ...
        { path: 'create', component: BlogCreateComponent ,canActivate: [isadminGuard, authGuard] },
        { path: 'stat', component: BlogStatComponent, canActivate: [authGuard] },
