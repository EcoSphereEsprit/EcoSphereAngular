...
@NgModule({
    imports: [RouterModule.forChild([
        ...
        { path: 'verifyotpforpassword', loadChildren: () => import('./verifyOtpForPasswordChange/newpassword.module').then(m => m.NewPasswordModule) },
        { path: 'savepicture', loadChildren: () => import('./savepicture/newpassword.module').then(m => m.NewPasswordModule) },
        { path: 'verifypicture', loadChildren: () => import('./verifyPicture/newpassword.module').then(m => m.NewPasswordModule) },
